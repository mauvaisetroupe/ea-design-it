...
describe('Service Tests', () => {
  describe('Owner Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Owner', async () => {
      ...
      it('should not update a Owner', async () => {
      ...
      it('should not partial update a Owner', async () => {
      ...
      it('should not return a list of Owner', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Owner', async () => {
