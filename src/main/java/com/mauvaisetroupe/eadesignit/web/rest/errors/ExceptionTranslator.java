...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.mauvaisetroupe.eadesignit.service.EmailAlreadyUsedException ||
            ex instanceof com.mauvaisetroupe.eadesignit.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.mauvaisetroupe.eadesignit.service.InvalidPasswordException
