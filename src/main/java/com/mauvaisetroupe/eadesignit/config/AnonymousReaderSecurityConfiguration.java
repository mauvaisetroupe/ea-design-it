...
import com.mauvaisetroupe.eadesignit.web.filter.SpaWebFilter;
...
public class AnonymousReaderSecurityConfiguration {

    private final Environment env;

    private final JHipsterProperties jHipsterProperties;

    public AnonymousReaderSecurityConfiguration(Environment env, JHipsterProperties jHipsterProperties) {
        this.env = env;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/**")).hasAnyAuthority(AuthoritiesConstants.USER)
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/authenticate")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/authenticate")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/account/anoymous-reader")).permitAll()
