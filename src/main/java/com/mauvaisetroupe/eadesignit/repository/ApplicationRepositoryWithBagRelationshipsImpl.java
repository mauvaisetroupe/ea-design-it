...
public class ApplicationRepositoryWithBagRelationshipsImpl implements ApplicationRepositoryWithBagRelationships {
    ...
    Application fetchCategories(Application result) {
        return entityManager
            .createQuery(
                "select application from Application application left join fetch application.categories where application.id = :id",
                Application.class
            )
    ...
    List<Application> fetchCategories(List<Application> applications) {
        ...
        List<Application> result = entityManager
            .createQuery(
                "select application from Application application left join fetch application.categories where application in :applications",
                Application.class
            )
    ...
    Application fetchTechnologies(Application result) {
        return entityManager
            .createQuery(
                "select application from Application application left join fetch application.technologies where application.id = :id",
                Application.class
            )
            .setParameter("id", result.getId())
            .getSingleResult();
    ...
    List<Application> fetchTechnologies(List<Application> applications) {
        ...
        List<Application> result = entityManager
            .createQuery(
                "select application from Application application left join fetch application.technologies where application in :applications",
                Application.class
            )
            .setParameter("applications", applications)
            .getResultList();
    ...
    Application fetchExternalIDS(Application result) {
        return entityManager
            .createQuery(
                "select application from Application application left join fetch application.externalIDS where application.id = :id",
                Application.class
            )
            .setParameter("id", result.getId())
            .getSingleResult();
    ...
    List<Application> fetchExternalIDS(List<Application> applications) {
        ...
        List<Application> result = entityManager
            .createQuery(
                "select application from Application application left join fetch application.externalIDS where application in :applications",
                Application.class
            )
            .setParameter("applications", applications)
            .getResultList();
