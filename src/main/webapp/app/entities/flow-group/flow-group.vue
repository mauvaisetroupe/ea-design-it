<template>
  <div>
    ...
    <div class="alert alert-warning" v-if="!isFetching && flowGroups && flowGroups.length === 0">
      <span>No Flow Groups found</span>
    </div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="eaDesignItApp.flowGroup.delete.question" data-cy="flowGroupDeleteDialogHeading">Confirm delete operation</span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-flowGroup-heading">Are you sure you want to delete Flow Group {{ removeId }}?</p>
      </div>
