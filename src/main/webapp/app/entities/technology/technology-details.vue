<template>
  <div class="row justify-content-center">
    <div class="col-8">
      <div v-if="technology">
        <h2 class="jh-entity-heading" data-cy="technologyDetailsHeading"><span>Technology</span> {{ technology.id }}</h2>
...
<script lang="ts" src="./technology-details.component.ts"></script>
