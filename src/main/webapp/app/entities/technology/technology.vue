  ...
  <div>
    <h2 id="page-heading" data-cy="TechnologyHeading">
      ...
      <div class="d-flex justify-content-end">
        ...
        <router-link :to="{ name: 'TechnologyCreate' }" custom v-slot="{ navigate }" v-if="$store.getters.authenticated">
          <button
            @click="navigate"
            id="jh-create-entity"
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="eaDesignItApp.technology.delete.question" data-cy="technologyDeleteDialogHeading">Confirm delete operation</span></span
      >
