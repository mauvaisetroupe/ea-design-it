  ...
  <div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="eaDesignItApp.capability.delete.question" data-cy="capabilityDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-capability-heading">Are you sure you want to delete this Capability?</p>
      </div>
