...
export default class CapabilityService {
  ...
  public create(entity: ICapability): Promise<ICapability> {
    return new Promise<ICapability>((resolve, reject) => {
      axios
  ...
  public update(entity: ICapability): Promise<ICapability> {
    return new Promise<ICapability>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: ICapability): Promise<ICapability> {
    return new Promise<ICapability>((resolve, reject) => {
      axios
